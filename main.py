...
app.config['SQLALCHEMY_DATABASE_URI'] = "mysql+pymysql://build-a-blog:DeathtoAhri69@localhost:5000/build-a-blog"
...
def blog():
    ...
    if blog_id == None:
        ...
        return render_template("todos.html", posts=posts, title="Build-a-blog")
    else:
